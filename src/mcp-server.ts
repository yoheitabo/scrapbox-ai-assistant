...
export class ScrapboxMCPServer {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              projects: {
                type: "array",
                items: { type: "string" },
                description: "Project names to search in",
              },
              tags: { type: "array", items: { type: "string" }, description: "Filter by tags" },
              creativeType: {
                type: "string",
                enum: ["poetry", "essay", "criticism", "note", "diary"],
          ...
          inputSchema: {
            ...
            properties: {
              ...
              connectionTypes: {
                ...
                items: {
                  type: "string",
                  enum: ["direct_link", "tag_similarity", "content_similarity"],
                },
              },
            },
      ...
      prompts: [
        {
          ...
          arguments: [
            ...
            {
              name: "perspective",
              description: "Analytical perspective or theory to apply",
              required: false,
            },
          ],
        },
  ...
  private async handleAnalyzeConnections(args: {
    ...
    for (const otherPage of project.pages) {
      if (otherPage.title === page.title) continue;
  ...
  private async handleExtractThemes(args: {
    ...
    for (const page of pages) {
      for (const tag of page.tags) {
        ...
        // biome-ignore lint/style/noNonNullAssertion: themes.set() was called just above
